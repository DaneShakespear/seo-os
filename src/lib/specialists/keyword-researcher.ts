  ...
  async execute(ctx) {
    ...
    await updateCanonicalNote(
      ...
      [
        ...
        "Canonical URL rules override heuristic matching. The homepage owns the designated primary limo-service terms; `/services/` owns broader service-category and comparison variants.",
        "",
        keywordTable,
        "",
